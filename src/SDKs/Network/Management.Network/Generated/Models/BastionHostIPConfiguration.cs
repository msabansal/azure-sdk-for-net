...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class BastionHostIPConfiguration : SubResource
    {
        ...
        /// <param name="subnet">Reference of the subnet resource. This field
        /// is a mandatory input.</param>
        /// <param name="publicIPAddress">Reference of the PublicIP resource.
        /// This field is a mandatory input.</param>
        ...
        public BastionHostIPConfiguration(string id = default(string), SubResource subnet = default(SubResource), SubResource publicIPAddress = default(SubResource), string provisioningState = default(string), string privateIPAllocationMethod = default(string), string name = default(string), string etag = default(string), string type = default(string))
            : base(id)
        {
            Subnet = subnet;
        ...
        /// <summary>
        /// Gets or sets reference of the subnet resource. This field is a
        /// mandatory input.
        /// </summary>
